...
class Ring {
  //property
  float x, y, vx, vy, r, w, x0, y0, v0, t;
  int siteswap, seqflag, handflag;//LEFT handflag = -1, RIGHT 1 
  //constructa
  Ring(float _x0, float _y0, float _r, float _w) {
    x0 = _x0;
    y0 = _y0;
    r = _r;
    w = _w;
